...
import static service.cn.com.rxdownload.utils.Utils.GMTToLong;
import static service.cn.com.rxdownload.utils.Utils.closeQuietly;
import static service.cn.com.rxdownload.utils.Utils.isChunked;
...
//        log.e("Thread: " + Thread.currentThread().getName() + "; saveFile start, content length: " + response.contentLength());
        try {
            try {
                int readLen;
                ...
                long oldStart = start;
                System.out.println("111111:i:"+i);
                System.out.println("111111:start:"+start);
